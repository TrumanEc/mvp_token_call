...
INSERT INTO "new_Position" ("amount", "createdAt", "currentOwnerId", "id", "initialProbability", "isForSale", "lastTransferredAt", "marketId", "originalOwnerId", "payout", "side", "status", "updatedAt") SELECT "amount", "createdAt", "currentOwnerId", "id", "initialProbability", "isForSale", "lastTransferredAt", "marketId", "originalOwnerId", "payout", "side", "status", "updatedAt" FROM "Position";
DROP TABLE "Position";
