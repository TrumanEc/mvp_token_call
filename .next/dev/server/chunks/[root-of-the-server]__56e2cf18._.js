...
"[project]/src/app/api/markets/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const markets = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$market$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MarketService"].getAll(status || undefined);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(markets);
}
async function POST(request) {
    const body = await request.json();
    const { playerName, question, description, resolutionDate, maxPool, maxBetAmount, maxPriceImpact, b } = body;
    ...
    const market = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$market$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MarketService"].create({
        playerName,
        question,
        description,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56e2cf18._.js.map