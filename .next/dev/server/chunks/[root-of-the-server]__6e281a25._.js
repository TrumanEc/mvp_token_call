...
"[project]/src/app/api/admin/markets/[id]/lmsr-logs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        const snapshots = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].lmsrSnapshot.findMany({
            where: {
                marketId: id
            },
            orderBy: {
        ...
        const userIds = Array.from(new Set(snapshots.map((s)=>s.userId).filter(Boolean)));
        // Fetch user details
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e281a25._.js.map